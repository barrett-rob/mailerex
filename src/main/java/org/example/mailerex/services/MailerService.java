...
public class MailerService {
    ...
    private final MailerSelectionService mailerSelectionService = new MailerSelectionService(); // should be injected
    ...
    public MailerResponse process(MailerRequest mailerRequest) {
        Mailer mailer = mailerSelectionService.selectMailer();
